...
import (
	...
	"sparks/internal/favorite/service"
	"time"
)

const (
	// grpc 服务名
	MyService = constant.FavoriteServiceName
	// grpc 服务端口
	port = constant.FavoriteServicePort
	// etcd 端口
...
func main() {
	...
	proto.RegisterFavoriteServiceServer(server, &service.FavoriteServiceImpl{})
