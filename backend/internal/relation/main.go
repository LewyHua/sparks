...
import (
	...
	"sparks/internal/relation/service"
	"time"
)

const (
	// grpc 服务名
	MyService = constant.RelationServiceName
	// grpc 服务端口
	port = constant.RelationServicePort
	// etcd 端口
...
func main() {
	...
	proto.RegisterRelationServiceServer(server, &service.RelationServiceImpl{})
